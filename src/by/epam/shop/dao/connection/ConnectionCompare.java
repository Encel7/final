...
public class ConnectionCompare implements Connection, Comparable<ConnectionCompare>  {

    private static final Logger LOG = LogManager.getLogger("name");

    private Connection connection;

    public ConnectionCompare(Connection connection) {
    ...
    public void close() throws SQLException {
        try {
            PoolConnection.getInstance().freeConnection(this);
    ...
    @Override
    public int compareTo(ConnectionCompare connection) {
