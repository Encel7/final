    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 ex1" style="background-color: dimgrey">
                <label for="exampleInputFirstName"><fmt:message bundle="${locale}" key="body.firstname"/></label>
                <input type="text" name="firstname" id="exampleInputFirstName"
                       class="form-control" placeholder="First Name" required value="${fname}">

                <label for="exampleInputLastName"><fmt:message bundle="${locale}" key="body.lastname"/></label>
                <input type="text" name="lastname" id="exampleInputLastName"
                       class="form-control"
                       placeholder="Last Name" required value="${lname}">

                <label for="exampleInputLogin"><fmt:message bundle="${locale}" key="body.login"/></label>
                <input type="text" name="login" class="form-control"
                       id="exampleInputLogin" placeholder="Login" required value="${login}">
                ...
                <label for="exampleInputPasswordRepeat"><fmt:message bundle="${locale}" key="body.repeat"/></label>
                <input type="password" name="repeatPassword" id="exampleInputPasswordRepeat"
                       class="form-control" required placeholder="Repeat Password">

                <button type="submit" class="btn btn-danger center-block"><fmt:message bundle="${locale}" key="body.createaccount"/></button>
            </div>
        </div>
    </div>
</form>
